...
[#assign NFC12A1_LED1_PORT = ""]
[#assign NFC12A1_LED1_PIN = ""]
[#assign NFC12A1_LED2_PORT = ""]
[#assign NFC12A1_LED2_PIN = ""]
[#assign NFC12A1_LED3_PORT = ""]
[#assign NFC12A1_LED3_PIN = ""]
	...
	[#if SWIP.variables??]
		[#list SWIP.variables as variables]
			...
			[#if variables.value?contains("GREEN LED")]
				[#assign NFC12A1_LED1_PORT = IpName]
				[#assign NFC12A1_LED1_PIN = IpInstance]				
			[/#if]
			[#if variables.value?contains("BLUE LED")]
				[#assign NFC12A1_LED2_PORT = IpName]
				[#assign NFC12A1_LED2_PIN = IpInstance]				
			[/#if]
			[#if variables.value?contains("YELLOW LED")]
				[#assign NFC12A1_LED3_PORT = IpName]
				[#assign NFC12A1_LED3_PIN = IpInstance]				
			[/#if]			
		[/#list]
	[/#if]
  [/#list]
